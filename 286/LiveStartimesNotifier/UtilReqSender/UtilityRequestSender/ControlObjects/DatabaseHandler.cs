...
namespace UtilReqSender.ControlObjects
{
    public class DatabaseHandler
    {
        ...
        internal void LogRequestAndResponse(string Utility, string vendorTranId, string request, string response)
        {
            try
            {
                string[] parameters = { Utility, vendorTranId, request, response };

                PegPayInterface.ExecuteNonQuery("LogXmlRequestResponseNew", parameters);
            }
            catch (Exception ex)
            {
