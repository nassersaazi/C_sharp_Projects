...
public class PegPay : System.Web.Services.WebService
{
    ...
    public string GetServerStatus()
    {
        ...
        try
        {
            ...
            string sourceIp = GetServerIpIpValue();
            string ip = getRequestIp();
            pegpay.SavePrepaidTransactionRequest("Leve1Api", "Server Status", "Server status", "status", "server status", "GetServerStatus", ip, sourceIp);
    ...
    public Response GetTransactionDetails(QueryRequest query)
    {
        ...
        //handler.SavePrepaidTransactionRequest(query.QueryField5, query.QueryField4, "", query.QueryField1, "GetTransactionDetails",ip);
        System.Net.ServicePointManager.ServerCertificateValidationCallback = RemoteCertificateValidation;
        PegPayUtilityApi.PegPayApi.PegPay pegpay = new PegPayUtilityApi.PegPayApi.PegPay();
        ...
        try
        {
            ...
            string ip = getRequestIp();
            handler.LogIp(ip, query.QueryField5);
            pegpay.SavePrepaidTransactionRequest("Leve1Api",query.QueryField5, query.QueryField4, "", query.QueryField1, "GetTransactionDetails", ip, sourceIp);
            ...
            if (qResp.StatusCode.Equals("0"))
            {
                ...
                resp.ResponseField14 = qResp.ServiceFee;
                resp.ResponseField15 = qResp.PayAccount;
                resp.ResponseField16 = qResp.DebtRecovery;
                resp.ResponseField17 = qResp.ReceiptNumber;
                resp.ResponseField18 = qResp.Forex;
                resp.ResponseField19 = qResp.Fuel;
                resp.ResponseField20 = qResp.Inflation;
                resp.ResponseField21 = qResp.Lifeline;
                resp.ResponseField22 = qResp.VAT;
                resp.ResponseField23 = qResp.TokenValue;
            }
            else
            {
                resp.ResponseField6 = qResp.StatusCode;
    ...
    {
        //string ip = getRequestIp();
        //handler.SavePrepaidTransactionRequest(query.QueryField5, query.QueryField4, "", query.QueryField1, "GetPrepaidVendorDetails",ip);
        System.Net.ServicePointManager.ServerCertificateValidationCallback = RemoteCertificateValidation;
        PegPayUtilityApi.PegPayApi.PegPay pegpay = new PegPayUtilityApi.PegPayApi.PegPay();
        Response resp = new Response();
        try
        {
            ...
            string sourceIp = GetServerIpIpValue();
            string ip = getRequestIp();
            pegpay.SavePrepaidTransactionRequest("Leve1Api",query.QueryField5, query.QueryField4, "", query.QueryField1, "GetPrepaidVendorDetails", ip, sourceIp);
    ...
    public Response QueryCustomerDetails(QueryRequest query)
    {
        //string ip = getRequestIp();
        ////handler.LogIp(ip, query.QueryField5);
        //handler.SavePrepaidTransactionRequest(query.QueryField5, query.QueryField4, "", query.QueryField1, "QueryCustomerDetails", ip);
        System.Net.ServicePointManager.ServerCertificateValidationCallback = RemoteCertificateValidation;
        PegPayUtilityApi.PegPayApi.PegPay pegpay = new PegPayUtilityApi.PegPayApi.PegPay();
        ...
        try
        {
            ...
            string ip = getRequestIp();
            //handler.LogIp(ip, query.QueryField5);
            DataTable VendorIPAccess = pegpay.GetVendorIPAccess(query.QueryField5, sourceIp);
            pegpay.SavePrepaidTransactionRequest("Leve1Api",query.QueryField5, query.QueryField4, "", query.QueryField1, "QueryCustomerDetails", ip, sourceIp);
            if ((VendorIPAccess.Rows.Count > 0))
            {
                if (!bool.Parse(VendorIPAccess.Rows[0]["ISActive"].ToString()))
                {
                    queryResponse.ResponseField1 = "";
                    queryResponse.ResponseField2 = "";
                    queryResponse.ResponseField3 = "";
                    queryResponse.ResponseField4 = "";
                    queryResponse.ResponseField6 = "303";
                    queryResponse.ResponseField7 = "VENDRO IP ACCESS HAS BEEN DEACTIVATED,PLEASE CONTACT PEGASUS TECHNOLOGIES";
                }

               else if (query.QueryField4 == null)
                {
                    queryResponse.ResponseField1 = "";
                    queryResponse.ResponseField2 = "";
                    queryResponse.ResponseField3 = "";
                ...
                else
                {
                    ...
                    else if (query.QueryField4.ToUpper().Equals("SOLAR"))
                    {
                        ...
                        string merchant = query.QueryField3;

                        SolarCustomer customer = pegpay.ValidateSolarCustomer(utilitycode, meternumber, vendorCode, password, merchant);
                    ...
                    else if (query.QueryField4.Equals("NDA"))
                    {
                        SchoolsQueryResponse resp = pegpay.QueryNDAInvoiceDetails(query.QueryField4, query.QueryField1, query.QueryField5, query.QueryField6);
                        if (resp.StatusCode.Equals("0"))
                        {
                            ...
                            queryResponse.ResponseField4 = resp.OutstandingBalance;
                            queryResponse.ResponseField5 = resp.Forex;
                            queryResponse.ResponseField8 = resp.Level;
                    ...
                    else if (query.QueryField4.Equals("NWSC"))
                    {
                        ...
                        if (nwscResp.StatusCode.Equals("0"))
                        {
                            ...
                            queryResponse.ResponseField4 = nwscResp.CustomerBalance;
                    ...
                    else if (query.QueryField4.Equals("URA"))
                    {
                        ...
                        if (uraResp.StatusCode.Equals("0"))
                        {
                            ...
                            queryResponse.ResponseField8 = uraResp.PaymentRegistrationDate;
                            queryResponse.ResponseField9 = uraResp.PrnStatus; //Expiry Date
                    ...
                    else if (query.QueryField4.Equals("REA") || query.QueryField4.Equals("KIL"))
                    {
                        string utilitycode = query.QueryField4;
                        string meternumber = query.QueryField1;
                        string vendorCode = query.QueryField5;
                        string password = query.QueryField6;
                        string area = query.QueryField3;
                        //Meter reaResp = pegpay.QueryREACustomerDetails(meternumber, area, vendorCode, password);
                        Meter reaResp = pegpay.QueryREACustomerDetails(meternumber, utilitycode, vendorCode, password);
                        if (reaResp.ErrorCode.Equals("0"))
                        {
                            queryResponse.ResponseField1 = reaResp.MeterNo;
                            queryResponse.ResponseField2 = reaResp.CustomerName;
                            queryResponse.ResponseField3 = reaResp.Address;
                            queryResponse.ResponseField4 = reaResp.Currentmonthmoney;
                            queryResponse.ResponseField6 = reaResp.ErrorCode;
                            queryResponse.ResponseField7 = reaResp.ErrorMsg;
                        }
                        else
                        {
                            queryResponse.ResponseField1 = "";
                    ...
                    else if (query.QueryField4.Equals("CONLOG"))
                    {
                        string utilitycode = query.QueryField4;
                        string meternumber = query.QueryField1;
                        string vendorCode = query.QueryField5;
                        ...
                        UmemeQueryResponse reaResp = pegpay.QueryCONLOGCustomer(meternumber);
                        if (reaResp.StatusCode.Equals("0"))
                        {
                            queryResponse.ResponseField1 = reaResp.CustomerReference;
                            queryResponse.ResponseField2 = reaResp.CustomerName;
                            queryResponse.ResponseField3 = "";
                            queryResponse.ResponseField4 = reaResp.CustomerBalance;
                            queryResponse.ResponseField6 = reaResp.StatusCode;
                            queryResponse.ResponseField7 = reaResp.StatusDescription;
                        }
                        else
                        {
                            queryResponse.ResponseField1 = "";
                    ...
                    else if (query.QueryField4.Equals("UMEME"))
                    {
                        ...
                        if (umemeResp.StatusCode.Equals("0"))
                        {
                            ...
                            queryResponse.ResponseField4 = umemeResp.CustomerBalance;
                    ...
                    else if (query.QueryField4.Equals("INFOCOM"))
                    {
                        NWSCQueryResponse NssfResp = pegpay.QueryINFOCOMCustomer(query.QueryField1, query.QueryField2,
                            query.QueryField5, query.QueryField6);
                        if (NssfResp.StatusCode.Equals("0"))
                        {
                            queryResponse.ResponseField1 = NssfResp.CustomerReference;// EmployerNo;
                            queryResponse.ResponseField2 = NssfResp.CustomerName;// CustomerReference;
                            queryResponse.ResponseField4 = NssfResp.CustomerBalance;
                            //queryResponse.ResponseField8 = NssfResp.paymentMethod;
                            //queryResponse.ResponseField9 = NssfResp.Period;
                    ...
                    else if (query.QueryField4.Equals("NSSF"))
                    {
                        ...
                        {
                            queryResponse.ResponseField1 = NssfResp.CustomerReference;// EmployerNo;
                            queryResponse.ResponseField2 = NssfResp.Employer;// CustomerReference;
                            queryResponse.ResponseField4 = NssfResp.OutstandingBalance;
                            queryResponse.ResponseField8 = NssfResp.paymentMethod;
                            queryResponse.ResponseField9 = NssfResp.Period;
                            queryResponse.ResponseField10 = NssfResp.employerNo;
                            queryResponse.ResponseField6 = "0";
                            queryResponse.ResponseField7 = NssfResp.StatusDescription;
                        }
                        else
                    ...
                    else if (query.QueryField4.Equals("STB_SCHOOL") || query.QueryField4.Equals("FLEXIPAY"))
                    {
                        ...
                        if (resp.StatusCode == "0")
                        {
                            ...
                            queryResponse.ResponseField15 = resp.BankId;
                        }
                    ...
                    else if (query.QueryField4.Equals("GTP"))
                    {

                        GtpCustomerResponse gtpResp = pegpay.QueryGTPCustomerDetails(query.QueryField1, query.QueryField5, query.QueryField6);
                        if (gtpResp.StatusCode.Equals("0"))
                        {

                            queryResponse.ResponseField1 = query.QueryField1;// nwscResp.CustomerReference;
                            queryResponse.ResponseField2 = gtpResp.FirstName + " " + gtpResp.MiddleName + " " + gtpResp.LastName;
                            queryResponse.ResponseField3 = "";// nwscResp.Area;
                            queryResponse.ResponseField4 = "";// nwscResp.CustomerBalance;
                            queryResponse.ResponseField6 = gtpResp.StatusCode;
                            queryResponse.ResponseField7 = gtpResp.StatusDescription;
                            queryResponse.ResponseField8 = gtpResp.MobilePhoneNumber;
                            queryResponse.ResponseField9 = gtpResp.PreferredName;
                            queryResponse.ResponseField10 = gtpResp.EmailAddress;
                            queryResponse.ResponseField11 = gtpResp.Address1;
                            queryResponse.ResponseField12 = gtpResp.Country;
                            queryResponse.ResponseField13 = gtpResp.CurrencyCode;
                    ...
                    else if (query.QueryField4.Equals("MOWE"))
                    {
                        UmemeQueryResponse umemeResp = pegpay.QueryMoweCustomer(query.QueryField1, query.QueryField5, query.QueryField6);
                        if (umemeResp.StatusCode.Equals("0"))
                        {
                            queryResponse.ResponseField1 = umemeResp.CustomerReference;
                            queryResponse.ResponseField2 = umemeResp.CustomerName;
                            queryResponse.ResponseField3 = umemeResp.Lifeline;
                            queryResponse.ResponseField11 = umemeResp.ReceiptNumber;
            ...
            else
            {
                ...
                queryResponse.ResponseField3 = "";
                queryResponse.ResponseField4 = "";
                queryResponse.ResponseField6 = "302";
                queryResponse.ResponseField7 = "VENDOR IP ACCESS ALLOWANCE NOT CONFIGURED,PLEASE CONTACT PEGASUS TECHNOLOGIES";
            }
        }
    ...
    {
        //string ip = getRequestIp();
        //handler.SavePrepaidTransactionRequest(query.QueryField5, query.QueryField4, "", query.QueryField1, "QueryLastFiveDetails", ip);
        Response resp = new Response();
        try
        {
            string sourceIp = GetServerIpIpValue();
            ...
            System.Net.ServicePointManager.ServerCertificateValidationCallback = RemoteCertificateValidation;
            PegPayUtilityApi.PegPayApi.PegPay pegpay = new PegPayUtilityApi.PegPayApi.PegPay();
            pegpay.SavePrepaidTransactionRequest("Leve1Api", query.QueryField5, query.QueryField4, "", query.QueryField1, "QueryLastFiveDetails", ip, sourceIp);
    ...
    {
        //string ip = getRequestIp();
        //handler.SavePrepaidTransactionRequest(query.QueryField5, query.QueryField4, "", query.QueryField1, "QuerySchoolDetails", ip);
        System.Net.ServicePointManager.ServerCertificateValidationCallback = RemoteCertificateValidation;
        PegPayUtilityApi.PegPayApi.PegPay pegpay = new PegPayUtilityApi.PegPayApi.PegPay();
        Response queryResponse = new Response();
        try
        {
            string sourceIp = GetServerIpIpValue();
            string ip = getRequestIp();
            pegpay.SavePrepaidTransactionRequest("Leve1Api", query.QueryField5, query.QueryField4, "", query.QueryField1, "QuerySchoolDetails", ip, sourceIp);
    ...
    public Response PostSchoolsTransaction(TransactionRequest trans)
    {
        ...
        //string ip = getRequestIp();
        //handler.SavePrepaidTransactionRequest(trans.PostField9, trans.PostField4, trans.PostField20, trans.PostField1, "PostSchoolsTransaction",ip);
        ...
        try
        {
            ...
            string sourceIp = GetServerIpIpValue();
            string ip = getRequestIp();
            pegpay.SavePrepaidTransactionRequest("Leve1Api", trans.PostField9, trans.PostField4, trans.PostField20, trans.PostField1, "PostSchoolsTransaction", ip, sourceIp);
    ...
    public Response PostTransaction(TransactionRequest trans)
    {
        ...
        //handler.SavePrepaidTransactionRequest(trans.PostField9, trans.PostField4, trans.PostField20, trans.PostField1, "PostTransaction", ip);
        System.Net.ServicePointManager.ServerCertificateValidationCallback = RemoteCertificateValidation;
        PegPayUtilityApi.PegPayApi.PegPay pegpay = new PegPayUtilityApi.PegPayApi.PegPay();
        pegpay.Timeout = 120000;
        Response postResponse = new Response();
        try
        {
            ...
            string ip = getRequestIp();
            //handler.LogIp(ip, trans.PostField9);
            pegpay.SavePrepaidTransactionRequest("Leve1Api",trans.PostField9, trans.PostField4, trans.PostField20, trans.PostField1, "PostTransaction", ip, sourceIp);
            ...
            else
            {
                ...
                else if (trans.PostField4.Equals("NDA"))
                {
                    schoolsTransaction schoolsTrans = GetSchoolsFeesTransaction(trans);
                    SchoolsPostResponse resp = pegpay.MakeNDAPayment(schoolsTrans);
                    if (resp.StatusCode.Equals("0"))
                    {
                        postResponse.ResponseField6 = resp.StatusCode;
                        postResponse.ResponseField7 = resp.StatusDescription;
                ...
                else if (trans.PostField4.Equals("REA"))
                {
                    REATransaction reaTrans = GetREATrans(trans);
                    PostResponse resp = pegpay.MakeREAPayment(reaTrans);
                    if (resp.StatusCode.Equals("0"))
                    {
                        postResponse.ResponseField6 = resp.StatusCode;
                        postResponse.ResponseField7 = resp.StatusDescription;
                ...
                else if (trans.PostField4.Equals("KIL"))
                {
                    REATransaction reaTrans = GetREATrans(trans);
                    PostResponse resp = pegpay.MakeKILEMBEPayment(reaTrans);
                    if (resp.StatusCode.Equals("0"))
                    {
                        postResponse.ResponseField6 = resp.StatusCode;
                        postResponse.ResponseField7 = resp.StatusDescription;
                ...
                else if (trans.PostField4.ToUpper().Equals("MOWE"))
                {
                    Transaction transs = GetMoweTransaction(trans);
                    PostResponse resp = pegpay.PostGenericTransaction(transs);
                ...
                else if (trans.PostField4.ToUpper().Equals("CONLOG"))
                {
                    Transaction transs = GetConlogTransaction(trans);
                    PostResponse resp = pegpay.PostGenericTransaction(transs);
                ...
                else if (trans.PostField4.Equals("NSSF"))
                {
                    URATransaction nssfTrans = GetNSSFTrans(trans);
                    PostResponse resp = pegpay.MakeNSSFPayment(nssfTrans);
                    if (resp.StatusCode.Equals("0"))
                    {
                        postResponse.ResponseField6 = resp.StatusCode;
                        postResponse.ResponseField7 = resp.StatusDescription;
                ...
                else if (trans.PostField4.ToUpper().Equals("GTP") )
                {

                    Transaction gtpTrans = GetGTPTrans(trans);
                    PostResponse resp = pegpay.MakeGtpTopup(gtpTrans);
    ...
    {
        //string ip = getRequestIp();
        //handler.SavePrepaidTransactionRequest(query.QueryField5, query.QueryField4, "", query.QueryField1, "GetPayTVBouquetDetails", ip);
        ...
        try
        {
            ...
            string sourceIp = GetServerIpIpValue();
            string ip = getRequestIp();
            pegpay.SavePrepaidTransactionRequest("Leve1Api", query.QueryField5, query.QueryField4, "", query.QueryField1, "GetPayTVBouquetDetails", ip, sourceIp);
    ...
    {
        //string ip = getRequestIp();
        //handler.SavePrepaidTransactionRequest(utility, utility, meterRef, meterRef, "ShowLastREAToken", ip);

        PegPayUtilityApi.PegPayApi.PegPay pegpay = new PegPayUtilityApi.PegPayApi.PegPay();
        string sourceIp = GetServerIpIpValue();
        string ip = getRequestIp();
        pegpay.SavePrepaidTransactionRequest("Leve1Api", utility, utility, meterRef, meterRef, "ShowLastREAToken", ip, sourceIp);
        System.Net.ServicePointManager.ServerCertificateValidationCallback = RemoteCertificateValidation;
        string lastToken = "";
        lastToken = pegpay.FetchLastREAToken(meterRef, utility);
        return lastToken;
    }
    ...
    {
        //string ip = getRequestIp();
        //handler.SavePrepaidTransactionRequest(trans.PostField9, trans.PostField4, trans.PostField20, trans.PostField1, "ReversePrepaidTransaction",ip);
        ...
        try
        {
            string sourceIp = GetServerIpIpValue();
            string ip = getRequestIp();
            pegpay.SavePrepaidTransactionRequest("Leve1Api",trans.PostField9, trans.PostField4, trans.PostField20, trans.PostField1, "ReversePrepaidTransaction", ip, sourceIp);
    ...
    public Response ReactivatePayTvCard(QueryRequest query)
    {
        //string ip = getRequestIp();
        ////handler.LogIp(ip, query.QueryField5);
        //handler.SavePrepaidTransactionRequest(query.QueryField5, query.QueryField4, "", query.QueryField1, "ReactivatePayTvCard",ip);
        ...
        try
        {
            ...
            string ip = getRequestIp();
            //handler.LogIp(ip, query.QueryField5);
            api.SavePrepaidTransactionRequest("Leve1Api", query.QueryField5, query.QueryField4, "", query.QueryField1, "ReactivatePayTvCard", ip, sourceIp);
    ...
    public Response PrepaidVendorPostTransaction(TransactionRequest trans)
    {
        //string ip = getRequestIp();
        //handler.LogIp(ip, trans.PostField9);
        //handler.SavePrepaidTransactionRequest(trans.PostField9, trans.PostField4, trans.PostField20, trans.PostField1, "PrepaidVendorPostTransaction", ip);
        Response postResponse = new Response();
        try
        {
            ...
            string ip = getRequestIp();
            handler.LogIp(ip, trans.PostField9);
            pegpay.SavePrepaidTransactionRequest("Leve1Api",trans.PostField9, trans.PostField4, trans.PostField20, trans.PostField1, "PrepaidVendorPostTransaction", ip, sourceIp);
            System.Net.ServicePointManager.ServerCertificateValidationCallback = RemoteCertificateValidation;
            pegpay.Timeout = 120000;
            if (trans.PostField4 == null)
            {
            ...
            else
            {
                if (trans.PostField4.Equals("NWSC") || trans.PostField4.Equals("UMEME") || trans.PostField4.Equals("STARTIMES") || trans.PostField4.Equals("URA")
                    ...
                    || trans.PostField4.Equals("MOBILEDATA") || trans.PostField4.Equals("MOWE"))
                {
                    NWSCTransaction nwscTrans = GetNWSCTrans(trans);
                    ...
                    else if (trans.PostField4.ToUpper() == "MOBILEDATA")
                    {
                        // resp = pegpay.MakeMobileDataPayment(nwscTrans);
                    }
                    else
                    {
    ...
    private REATransaction GetREATrans(TransactionRequest trans)
    {
        REATransaction transaction = new REATransaction();
        transaction.CustRef = trans.PostField1;
        transaction.CustName = trans.PostField2;
        transaction.CustomerType = (string.IsNullOrEmpty(trans.PostField21)) ? "" : trans.PostField21;
    ...
    private Transaction GetMoweTransaction(TransactionRequest trans)
    {
    ...
    private Transaction GetConlogTransaction(TransactionRequest trans)
    {
    ...
    private URATransaction GetNSSFTrans(TransactionRequest transaction)
    {
        ...
        trans.Narration = transaction.PostField18;
        trans.PaymentType = transaction.PostField6;
        trans.DigitalSignature = transaction.PostField16;
    ...
    private UmemeTransaction GetUmemeTrans(TransactionRequest trans)
    {
        ...
        transaction.Email = trans.PostField19;
        transaction.VendorTransactionRef = trans.PostField20;
        transaction.Tin = trans.PostField27;
        return transaction;
    }
    ...
    private Transaction GetGTPTrans(TransactionRequest trans)
    {
