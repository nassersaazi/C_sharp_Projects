...
public class DatabaseHandler
{
    ...
    //public void SavePrepaidTransactionRequest(string vendorCode, string utilityCode, string vendorTranId, string customerRef, string method, string sourceipAdress, string serverip)
    //{
    //    try
    //    {
    //        procommand = PegPay_DB.GetStoredProcCommand("SavePrepaidRequest", vendorCode, utilityCode, vendorTranId, customerRef, method, sourceipAdress, serverip); 
    //        PegPay_DB.ExecuteNonQuery(procommand);
    //    }
    //    catch (Exception ee)
    //    {
