<%@ Page Language="C#" MasterPageFile="~/MasterMain.master" AutoEventWireup="true" CodeFile="CreditUser.aspx.cs" Inherits="CreditUser" Title="Credit Vendor" %>
...
<div class="col-lg-12">
    <div class="card mb-3">
        ...
        <i class="fa fa fa-cog"></i> System tools <i class='fa fa-arrow-right'></i> Credit Users
        </div>
        <div class="card-body">
                ...
                <asp:View ID="View1" runat="server">
                   <div class="modal-content col-md-6  col-sm-6 col-xs-10"  style="margin:0 auto;">
                            ...
                            <div class="modal-footer">
                                <asp:Button ID="Button1" runat="server" CssClass="btn btn-success" OnClick="Button1_Click" Text="Credit User" />
                         </div>
                    </div>
                 </asp:View>
