<%@ Page Language="C#" MasterPageFile="~/MasterMain.master" AutoEventWireup="true" CodeFile="Tariff.aspx.cs" Inherits="Tariff" Title="LISTS" %>
...
<div class="col-lg-12">
    <div class="card mb-3">
        ...
        <i class="fa fa fa-cog"></i> System Tools <i class='fa fa-arrow-right'></i> Network Tariffs
        </div>
        <div class="card-body">
                ...
                <asp:View ID="View1" runat="server">
                    ...
                    <div class="modal-content col-md-8  col-sm-8 col-xs-10"  style="margin:0 auto;">
                        <div class="modal-header">
			                <center><h4>Add Tarrif</h4></center>
		                </div>
		                <div class="modal-body">
                   
                            Network
                            <asp:TextBox ID="txtNetwork" runat="server" CssClass="form-control"></asp:TextBox>
		        

                        Tarrif
                        <asp:TextBox ID="txtRate" runat="server" CssClass="form-control"></asp:TextBox>
                        <br/>
                        <asp:Button ID="Button1" runat="server" CssClass="btn btn-success" Text="Save Tariff" OnClick="Button1_Click" />
