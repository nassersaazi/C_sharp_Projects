<%@ Page Language="C#" MasterPageFile="~/MasterMain.master" AutoEventWireup="true" CodeFile="Sms_logs.aspx.cs" Inherits="Sms_logs" Title="SMS LOGS" %>
                    ...
                    <div class="col-md-2">
                     ...
                     <asp:DataGrid ID="DataGrid1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <PagerStyle  ForeColor="#4380B8"  HorizontalAlign="Center" Mode="NumericPages"  Font-Size="16"/>
                            ...
                            <asp:BoundColumn HeaderText="Group Name" DataField="ListName">
