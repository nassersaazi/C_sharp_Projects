<%@ Page Title="" Language="C#" MasterPageFile="~/MasterMain.master" AutoEventWireup="true" CodeFile="NonPresetSms.aspx.cs" Inherits="NonPresetSms" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="col-lg-12">
            ...
            <div class="card mb-3">
                ...
                <i class="fa fa fa-file"></i> Reports<i class='fa fa-arrow-right'></i>Inbound SMS Report
                </div>
                <div class="card-body row clearfix col-md-12">
                 <div class="col-md-2">
                        ...
                        <div class="col-md-2">
                            ...
                            <asp:DropDownList ID="ddlSmsType" runat="server" CssClass="form-control">
                                <asp:ListItem Value="">ALL</asp:ListItem>
                                 <asp:ListItem Value="True">Preset</asp:ListItem>
                                <asp:ListItem Value="False">Non Preset</asp:ListItem>
                            </asp:DropDownList>
                        </div>
                        <div class="col-md-2">
                        ...
                        <tr>
                         ...
                         <asp:MultiView ID="MultiView1" runat="server">
                            <asp:View ID="View1" runat="server">
                                    ...
                                    <Columns>
                                           <asp:ButtonColumn CommandName="btnEdit" HeaderText="Reply" Text="Reply">    
                                           </asp:ButtonColumn>   
