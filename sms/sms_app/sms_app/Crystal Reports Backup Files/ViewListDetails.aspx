<%@ Page Language="C#" MasterPageFile="~/MasterMain.master" AutoEventWireup="true" CodeFile="ViewListDetails.aspx.cs" Inherits="ViewListDetails" Title="LIST PHONE NUMBERS" %>
             ...
             <asp:MultiView ID="MultiView2" runat="server">
                <asp:View ID="View2" runat="server">
                    ...
                    <Columns>
                        ...
                        <asp:BoundColumn DataField="ListName" HeaderText="Group Name">
