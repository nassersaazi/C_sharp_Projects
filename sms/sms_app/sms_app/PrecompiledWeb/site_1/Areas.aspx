<%@ page language="C#" masterpagefile="~/MasterSetting.master" autoeventwireup="true" inherits="Areas, App_Web_hiefcs1v" title="AREAS" %>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="InterfaceHeaderLabel2" style="height: 18px; text-align: center">
                                                    <asp:Label ID="lblConferenceName" runat="server" Text="ADD/EDIT AREA"></asp:Label></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </td>
                                    ...
                                    <table align="center" cellpadding="0" cellspacing="0" style="width: 80%">
                                        <tr>
                                            ...
                                            <td class="InterFaceTableRightRow" style="height: 19px">
                                                <asp:TextBox ID="txtArea" runat="server" Width="90%"></asp:TextBox></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="InterFaceTableRightRow">
                                                <asp:TextBox ID="txtMask" runat="server" Width="90%" MaxLength="11"></asp:TextBox></td>
                                        </tr>
                                        <tr>
                                            <td colspan="3" style="height: 5px">
                                            </td>
                                        ...
                                        <td colspan="3" style="vertical-align: top; height: 5px; text-align: left">
                                            <table align="center" cellpadding="0" cellspacing="0" style="width: 98%">
                                                <tbody>
                                                    <tr>
                                                        <td class="InterfaceHeaderLabel2" style="height: 18px; text-align: center">
                                                            <asp:Label ID="Label1" runat="server" Text="AREAS LIST"></asp:Label></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </td>
