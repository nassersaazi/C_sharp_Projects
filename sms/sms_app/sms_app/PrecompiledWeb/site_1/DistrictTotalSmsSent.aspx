<%@ page language="C#" masterpagefile="~/MasterReports.master" autoeventwireup="true" inherits="ViewListSmsSent, App_Web_mibjsheb" title="VIEW SMS LOG" %>
                                    ...
                                    <tr>
                                        <td colspan="3" style="vertical-align: top; height: 5px; text-align: center; width: 100%;">
                                            <table align="center" cellpadding="0" cellspacing="0" style="border-right: #617da6 1px solid;
                                                ...
                                                <tr>
                                                    <td colspan="4" style="vertical-align: middle; height: 10px; text-align: center">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="4" style="border-right: #617da6 1px solid; border-top: #617da6 1px solid;
                                    ...
                                    <tr>
                                        <td colspan="3" style="vertical-align: top; width: 838px; height: 5px; text-align: center;">
                                            <table style="text-align:center;">
                                                <tr>
                                                    <td style="width: 100px; height: 20px; text-align:center" align="center">
                                    ...
                                    <tr>
                                        <td colspan="3" style="vertical-align: top; width: 100%; height: 4px; text-align: center">
                                                        ...
                                                        <table style="width: 100%; text-align:center;" >
                                                            <tr>
                                                                <td style=" width:26%;text-align:center;">
                                                                    <asp:Label ID="lblTotalNo" runat="server" ForeColor="Highlight"></asp:Label></td>
                                                                <td style=" width:27%; text-align:center;">
                                                                    </td>
                                                                <td style="width: 25%; text-align: center">
                                                                    <asp:Label ID="Label3" runat="server" ForeColor="Highlight"></asp:Label></td>
                                                            </tr>
                                                            <tr>
                                                                <td style="width: 26%; text-align: center">
                                                                    <asp:Label ID="Label6" runat="server" ForeColor="Highlight"></asp:Label></td>
                                                                <td style="width: 27%; text-align: center">
                                                                    <asp:Label ID="Label4" runat="server" ForeColor="Highlight"></asp:Label></td>
                                                                <td style="width: 25%; text-align: center">
                                                                    <asp:Label ID="Label5" runat="server" ForeColor="Highlight"></asp:Label></td>
                                                            </tr>
                                                            <tr>
                                                                <td style="width: 26%; text-align: center">
                                                                    <asp:Label ID="Label7" runat="server" ForeColor="Highlight"></asp:Label></td>
                                                                <td style="width: 27%; text-align: center">
                                                                </td>
                                                                <td style="width: 25%; text-align: center">
                                                                </td>
                                            ...
                                            <asp:DataGrid ID="DataGrid1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                                ...
                                                Width="95%" OnPageIndexChanged="DataGrid1_PageIndexChanged" PageSize="50" ShowFooter="True" OnSelectedIndexChanged="DataGrid1_SelectedIndexChanged">
                                                ...
                                                <tr>
                                                    <td colspan="5" style="border-right: #617da6 1px solid; border-top: #617da6 1px solid;
                                                        vertical-align: middle; border-left: #617da6 1px solid; border-bottom: #617da6 1px solid;
                                                        height: 23px; text-align: center">
                                                        <asp:Label ID="lblTotal" runat="server" Text="." Font-Bold="True" Font-Names="Cambria" Font-Size="Medium" ForeColor="Highlight"></asp:Label></td>
                                                </tr>
                                            </table>
