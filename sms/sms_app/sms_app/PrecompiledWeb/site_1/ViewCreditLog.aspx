<%@ page language="C#" masterpagefile="~/MasterReports.master" autoeventwireup="true" inherits="ViewCreditLog, App_Web_3xzxrege" title="VIEW CREDIT LOG" %>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="InterfaceHeaderLabel2" style="height: 18px; text-align: center">
                                                            <asp:Label ID="Label1" runat="server" Text="CREDIT ALLOCATION HISTORY"></asp:Label></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </td>
                                        ...
                                        <td colspan="3" style="vertical-align: top; height: 5px; text-align: center; width: 100%;">
                                            <table align="center" cellpadding="0" cellspacing="0" style="border-right: #617da6 1px solid;
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="vertical-align: middle; width: 25%; height: 23px; text-align: center"><asp:DropDownList ID="ddlUsers" runat="server" CssClass="InterfaceDropdownList"
                                        ...
                                        <td colspan="3" style="vertical-align: top; width: 100%; height: 4px; text-align: center">
                                            ...
                                            <asp:DataGrid ID="DataGrid1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundColumn DataField="AllocatedBy" HeaderText="AllocatedBy">
                                                        <HeaderStyle Width="20%" />
                                                    </asp:BoundColumn>
