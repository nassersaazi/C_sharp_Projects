<%@ page language="C#" masterpagefile="~/MasterSetting.master" autoeventwireup="true" inherits="Tariff, App_Web_hiefcs1v" title="LISTS" %>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="InterfaceHeaderLabel2" style="height: 18px; text-align: center">
                                                    <asp:Label ID="lblConferenceName" runat="server" Text="ADD/EDIT TARIFF"></asp:Label></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </td>
                                    ...
                                    <table align="center" cellpadding="0" cellspacing="0" style="width: 80%">
                                        <tr>
                                            ...
                                            <td class="InterFaceTableRightRow" style="height: 19px">
                                                <asp:TextBox ID="txtNetwork" runat="server" Width="90%"></asp:TextBox></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="InterFaceTableRightRow">
                                                <asp:TextBox ID="txtRate" runat="server" Width="90%"></asp:TextBox></td>
                                        </tr>
                                        <tr>
                                            <td colspan="3" style="height: 5px">
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="InterFaceTableRightRow">
                                                <asp:Button ID="Button1" runat="server" Font-Bold="True" Text="Save Tariff" OnClick="Button1_Click" /></td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
                                        ...
                                        <td colspan="3" style="vertical-align: top; height: 5px; text-align: left">
                                            <table align="center" cellpadding="0" cellspacing="0" style="width: 98%">
                                                <tbody>
                                                    <tr>
                                                        <td class="InterfaceHeaderLabel2" style="height: 18px; text-align: center">
                                                            <asp:Label ID="Label1" runat="server" Text="TARIFF LIST"></asp:Label></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </td>
                                        ...
                                        <td colspan="3" style="vertical-align: top; width: 100%; height: 4px; text-align: center">
                                            <asp:DataGrid ID="DataGrid1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:ButtonColumn CommandName="btnEdit" HeaderText="Edit" Text="Network" DataTextField="Network">
                                                        <HeaderStyle Width="20%" />
                                                        <ItemStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                                            Font-Underline="False" ForeColor="Blue" />
                                                    </asp:ButtonColumn>
                                                    <asp:BoundColumn DataField="Tarrif" HeaderText="Rate(UShs.)">
                                                        <HeaderStyle Width="20%" />
